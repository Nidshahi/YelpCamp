...
const { campgroundSchema } = require('../schemas/validateJoi');
...
router.post('', isLogged,validateData, catchAsync(async (req, res) => {
...
router.put('/:id', isLogged,validateData, catchAsync(async (req, res) => {
  const { id } = req.params;
